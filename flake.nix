...

    {
      ...
      devShells = forAllSystems (
        ...
        let
          ...
          qt-wrapper-env = packages'.fjordlauncherreunlocked.overrideAttrs (old: {
            name = "qt-wrapper-env";
      ...
      packages = forAllSystems (
        ...
        let
          ...
          packages = {
            inherit (fjordPackages) fjordlauncherreunlocked-unwrapped fjordlauncherreunlocked;
            default = fjordPackages.fjordlauncherreunlocked;
          };
        in
      ...
      legacyPackages = forAllSystems (
        ...
        {
          fjordlauncherreunlocked-debug = packages'.fjordlauncherreunlocked.override {
            fjordlauncherreunlocked-unwrapped = legacyPackages'.fjordlauncherreunlocked-unwrapped-debug;
          };

          fjordlauncherreunlocked-unwrapped-debug = packages'.fjordlauncherreunlocked-unwrapped.overrideAttrs {
            cmakeBuildType = "Debug";
            dontStrip = true;
          };
        }
